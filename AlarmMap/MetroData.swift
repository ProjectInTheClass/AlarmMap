...
func lineColor(line:String) -> UIColor {
    ...
    case "5호선":
        return #colorLiteral(red: 0.3763759136, green: 0.07760670036, blue: 0.365219444, alpha: 1)
    case "6호선":
        return #colorLiteral(red: 0.3009725809, green: 0.1450995505, blue: 0.06917008758, alpha: 1)
    case "7호선":
        return #colorLiteral(red: 0.04135468941, green: 0.2748137953, blue: 0.1355476831, alpha: 1)
    case "8호선":
    ...
    case "경춘선":
        return #colorLiteral(red: 0.08108980209, green: 0.3645184636, blue: 0.3434619904, alpha: 1)
    case "수인선":

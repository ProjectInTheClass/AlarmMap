...
class BusTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var busStopCell:BusStopTableViewCell
        var busCell:BusTableViewCell
        
        if indexPath.row == 0 {
            busStopCell = tableView.dequeueReusableCell(withIdentifier: "busStopTableViewCell") as! BusStopTableViewCell
            ...
            busCell = tableView.dequeueReusableCell(withIdentifier: "busTableViewCell") as! BusTableViewCell

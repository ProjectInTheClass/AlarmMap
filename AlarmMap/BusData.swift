...
class Bus {
    ...
    var firstBusRemainingTime: Int
    var firstBusCurrentLocation:String
    var secondBusRemainingTime: Int
    var secondBusCurrentLocation:String
    
    init(busNumber:String, firstBusRemainingTime:Int,firstBusCurrentLocation:String,secondBusRemainingTime:Int,secondBusCurrentLocation:String){
